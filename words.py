...
from pyOreo.fns.misc import get_synonyms_or_antonyms
from pyOreo.fns.tools import async_searcher

from . import get_string, oreo_cmd


@oreo_cmd(pattern="meaning( (.*)|$)", manager=True)
